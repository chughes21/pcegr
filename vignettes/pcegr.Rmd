...
However, we can also plot the models assuming the risk free edges and leaves have been removed.
...
plot(ziptree2)
```
We can also fit a ZIPCEG to this.
...
chi_sq_calculator(knee_pain_obs,ziptree1,limit=3)$chi_sq-chi_sq_calculator(knee_pain_obs,ziptree2,limit=3)$chi_sq
```
...
chi_sq_calculator(knee_pain_obs,maptree,limit=3,zip=TRUE)$chi_sq-chi_sq_calculator(knee_pain_obs,ziptree2,limit=3,zip=TRUE)$chi_sq
```
