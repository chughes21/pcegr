...
set.seed(13579)
ziptree2<-zipceg(knee_pain_obs,"Gibbs",iter=10000,variable_time = TRUE, remove_risk_free=TRUE, stoch_imputation = TRUE, gamma_alpha = a, gamma_beta = b, beta_c = c, beta_d = d)
summary(ziptree2)
plot(ziptree2)
```
