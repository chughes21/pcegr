...
+disc_length: The interval length to search for stages with which to merge. For example, if this is 1, it will only merge stages that are immediate neighbours when ordered. This is necessary when dealing with sparse edge counts. 
